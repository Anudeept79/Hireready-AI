...
export default function LinkedInPreview({ content, isEditing, onEdit, onSaveEdit, onCancelEdit }) {
    ...
    return (
      <div style={{ background: '#FFFFFF', borderRadius: 12, padding: 24 }}>
        <textarea
          ...
          style={{
            width: '100%', minHeight: 200, border: '1px solid #DDD', borderRadius: 8,
  ...
  return (
    <div style={{ background: '#FFFFFF', borderRadius: 12, padding: 32, position: 'relative' }}>
      ...
      <p style={{ fontSize: 13, fontWeight: 'bold', color: '#0A66C2', marginBottom: 12, fontFamily: 'Inter, system-ui' }}>
